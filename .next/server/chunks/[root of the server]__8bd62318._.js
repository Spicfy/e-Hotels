...
async function POST(req) {
    ...
    if (existingUser) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: "The mail has already been registerednode -e \"console.log(require('crypto').randomBytes(32).toString('hex'))\""
        }, {
            status: 400
        });
    }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__8bd62318._.js.map